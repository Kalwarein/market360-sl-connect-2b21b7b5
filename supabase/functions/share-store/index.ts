...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const storeUrl = `https://4b360025-8d48-456b-9a42-694a4c244c34.lovableproject.com/store/${storeId}`
    const shareUrl = `https://rhtqsqpdvawlfqxlagxw.supabase.co/functions/v1/share-store?id=${storeId}`
