...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const appUrl = Deno.env.get('APP_URL') || 'https://market360-sl-connect.lovable.app';
