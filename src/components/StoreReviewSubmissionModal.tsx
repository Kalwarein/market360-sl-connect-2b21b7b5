  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (storeData?.owner_id) {
        ...
        verifiedPurchase = orders && orders.length > 0;
      }
      ...
      if (error) {
        ...
        if (error.code === '23505') {
          toast({
            ...
            description: 'You have already reviewed this store. You can edit your existing review instead.',
            variant: 'destructive',
          });
        } else {
          throw error;
