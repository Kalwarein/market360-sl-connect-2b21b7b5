  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Payment deducted and securely held in escrow.",
      });
      ...
      if (ledgerId) {
        await supabase.from("wallet_ledger").delete().eq("id", ledgerId);
      }
...
{!isBalanceSufficient && !loadingBalance && (    
  ...
  </div>    {/* Insufficient Balance Modal */}
